export default {
    ...
    media_refresh_failed: "The artwork exists, but its image links could not be refreshed. Please try again later. (PIXIV_REFRESH_FAILED)",
    ...
    error: "The request could not be completed because an unexpected processing error occurred. Please try again; if it keeps happening, contact the operator with code UNEXPECTED_PROCESSING_FAILURE.",
